...
Find the median of two sorted arrays in logarithmic-style search. Aim for a correct and efficient implementation, and explain the core idea and edge-case handling.
...
### Code
Source: `lectures/LeetCode/4.cpp`
